...
$(document).ready(function() {
  ...
  $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/fetch_record.php",
        type: "POST",
        dataType: 'json',
        data: {
          id:my_id
  ...
  $('#update_record').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/update_record.php",
        type: "POST",
        data: {
           id_:id_,
   ...
   $('#add_expenses').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/new_expense.php",
        type: "POST",
        data: {
           id_:id_,
           property:property,
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/update_profile.php",
        type: "POST",
        data: {
           username:id_,
           fname:fname,
   ...
   $('#update_unit').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/update_unit.php",
        type: "POST",
        data: {
           id:id_,
           type:type,
  ...
  $('#delete_record').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/delete_record.php",
        type: "POST",
        data: {
           id_:id_,
           payment_ref:payment_ref,
   ...
   $('#delete_user').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/delete_user.php",
        type: "POST",
        data: {
           id_:id_,
           payment_ref:payment_ref,
    ...
    $('#add_unit_edit').on('submit', function (e) {
        if (!e.isDefaultPrevented()) {
            ...
            var url = "http://vycansdigital.co.ke/ajax/add_unit.php";
            $.ajax({
                type: "POST",
                url: url,
                data: $(this).serialize(),
  ...
  $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/fetch_expense.php",
        type: "POST",
        dataType: 'json',
        data: {
          id:my_id
  ...
  $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/fetch_request.php",
        type: "POST",
        dataType: 'json',
        data: {
          id:my_id
  ...
  $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/fetch_user.php",
        type: "POST",
        dataType: 'json',
        data: {
          id:my_id
  ...
  $('#delete_expense').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/delete_expense.php",
        type: "POST",
        data: {
           id_:id_,
           payment_ref:payment_ref,
  ...
  $('a[data-toggle=modal], button[data-toggle=modal]').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/fetch_unit.php",
        type: "POST",
        dataType: 'json',
        data: {
          id:my_id
  ...
  $('#payexpenses').click(function () {
    ...
    $.ajax({
        url: "http://vycansdigital.co.ke/ajax/payexpense.php",
        type: "POST",
        data: {
           id_:id_,
           payment_ref:payment_ref,
