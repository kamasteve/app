...
//$query = $con->query("SELECT name FROM properties WHERE property_id = ".$_POST['property']."");
 ...
 $rent = $_REQUEST['rent'];
	...
	$update_unit="UPDATE rental_units SET unit_id='$unit_id', unit_type='$unit_type',bed='$beds',rent='$rent' where unit_id =$unnit_id"; //$tenant_id		
...
if (!$result_update_profile) {
				...
				echo 'Property updated sucessfully';
