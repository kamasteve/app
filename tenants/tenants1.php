...
<div class="row">
	<div class="box col-md-12">
		...
		<div class="alert_msg" id='alert_msg1' style='display:none;'></div>
			<h2><i class="glyphicon glyphicon-info-sign"></i> Tenants</h2>
...
<table id="example" class="display" cellspacing="0" width="100%">
	...
	?>
        <tr>
            ...
            <td >
			<button type='button' class='btn btn-default' data-toggle='modal' data-target='#model_<?php echo $row['tenant_id']; ?>'>Edit</button>	
